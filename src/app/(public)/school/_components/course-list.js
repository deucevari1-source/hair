...
import { Calendar, Clock, Users, ChevronDown, ChevronUp, X, Check } from 'lucide-react';
...
function EnrollModal({ course, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center p-0 md:p-4">
      <div className="absolute inset-0 bg-charcoal-900/40 backdrop-blur-sm" onMouseDown={onClose} />
